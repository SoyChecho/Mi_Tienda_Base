...
public class ProductoDAO {
	...
	ResultSet res = null;
	 ...
	 public boolean Cargar_Producto(String URL) {//STRIN URL es lo que me envia el servelet
		 boolean resul = false;
		 try {
			//Sentencia sql para subir datos del archivo a la tabla sql//+URL+ concatena la variable de la url
