...
public class ClienteDAO {
	...
	//METODO PARA ACTUALIZAR
	 ...
	 public ArrayList<ClienteDTO> cargarCliente(){
		 ClienteDTO cli = null;
		 ArrayList<ClienteDTO> lista=new ArrayList<>();//para que cada libro se sume a la lista
		 ...
		 try {
			 ...
			 while(res.next()){//recorrer el resultado de la consulta
				 ...
				 cli = new ClienteDTO(res.getInt(1),res.getInt(2),res.getString(3),res.getString(4),res.getString(5));
				 lista.add(cli);
			 }
		 }catch(SQLException ex) {
